          ...
          <div className="col-span-4">
            <CardContent title="Add person">
              <form action="" className="mx-[10px] my-[20px]">
                <div className="grid grid-cols-1 gap-x-[15px] mb-[15px]">
                  <div>
                    ...
                    <select name="first_name" id="first_name" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
              ...
              <div className='flex flex-col rounded'>
                {mock.map(() => <div className='flex items-center p-2 justify-between hover:bg-gray-200'>

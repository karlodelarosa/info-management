    ...
    <div className="w-full h-screen bg-blue-900 flex items-center justify-center">
      <div className="w-[500px] bg-white rounded-2xl p-[25px]">
        ...
        <form className="flex flex-col gap-[10px]">
          <div>
            <label htmlFor="username" className="uppercase text-sm font-bold">
              Username or Email:
            </label>
            <input
              type="text"
              id="username"
              className="w-full rounded px-2 py-2 border border-gray-300 focus:outline outline-blue-700"
            />
          </div>
          <div>
          ...
          <div className="mt-[20px]">
            <button onClick={goToDashboard} className="w-full bg-blue-900 text-white rounded py-3">
              Sign in
            </button>
          </div>
        </form>
